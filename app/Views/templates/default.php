                ...
                <div class="container">
                    <footer class="border-top py-4 text-center">
                        <span class="text-secondary">
                            ...
                            <a class="text-decoration-none me-2" href="<?= config('Urls')->github ?>"><i class="bi bi-github"></i> GitHub</a> <a class="text-decoration-none" href="<?= config('Urls')->github ?>/blob/main/README.md"><i class="bi bi-file-earmark-text-fill"></i> README</a>
                        </span>
                        <?php // is_admin session is set and true
                        if( session()->get('is_admin') ):
                        ?>
